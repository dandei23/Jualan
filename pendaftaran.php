...
<link href="pendaftaran.css" rel="stylesheet" type="text/css" />
<style type="text/css">
body {
	font-family: "Lucida Grande", "Lucida  San Unicode", Verdana,  Arial. Helvetica, san-serif;
	font-size: 12px;
}
...
#login {
	...
	margin:30px 0 20px 0;
	padding:10px; background: #efdb9e;
	font-size: 10px; color:#95844D;
...
.meta {
	font-size: 9px; background: #f1e0ac;
...
<div id="stylized" class="myform">
	<form id="form" name="form" method="post" action="beranda.php">
      <h1>Form Sign up</h1>
      <label>Name</label>
